...
# MAGIC | | |
# MAGIC |---|---|
# MAGIC | **Source** | `harsh_kumar01_npmentorskool_onmicrosoft_com.bronze.products` — CDF enabled |
# MAGIC | **Target** | `harsh_kumar01_npmentorskool_onmicrosoft_com.silver.products` |
...
LAST_PROCESSED_VERSION = 2   # <-- set this from the history output above
