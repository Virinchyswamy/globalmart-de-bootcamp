...
## Overview
Build a complete Medallion Data Pipeline for GlobalMart's supply chain domain — Bronze ingestion, Silver data quality, dimensional model design, and a Gold Star Schema — using Autoloader, Lakeflow Connect, and Delta Lake on Databricks.
