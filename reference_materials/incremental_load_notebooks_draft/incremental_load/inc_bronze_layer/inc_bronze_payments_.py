...
# MAGIC %sql
# MAGIC select count(*) from gbmart.bronze.payments;
...
payments_inc_df = (
    spark.read
         ...
         .csv("abfss://ecom-gbmart-data@ecomadlsdata.dfs.core.windows.net/raw-data/payments/payments_040626.csv")
)
...
# MAGIC %sql
# MAGIC describe history gbmart.bronze.payments;
